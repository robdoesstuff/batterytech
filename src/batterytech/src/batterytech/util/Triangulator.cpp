		...
		TVEC2D *result, int *resultSize)
{
  ...
  *resultSize = 0;
  ...
  if ( 0.0f < Area(contour, contourSize) )
  ...
  for(int m=0, v=nv-1; nv>2; )
  {
    ...
    if ( Snip(contour,contourSize,u,v,w,nv,V) )
    {
      int a,b,c,s,t;
      ...
      /* output Triangle */
      result[(*resultSize)++] = contour[a];
      result[(*resultSize)++] = contour[b];
      result[(*resultSize)++] = contour[c];
